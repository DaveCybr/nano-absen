...
export default function InitSetup() {
  ...
  const handleFinish = () => navigate("/summary-report", { replace: true });
      ...
      <div className="w-full max-w-xl">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center gap-2 mb-3">
            ...
            <span className="text-lg font-bold text-gray-900">nano.HR</span>
          </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8">
          ...
          {step === "done" && (
            <div className="text-center">
              ...
              <p className="text-sm text-gray-500 mb-8">
                Sistem nano.HR siap digunakan. Kamu sudah terdaftar sebagai{" "}
                <span className="font-medium text-blue-600">
                  HR Administrator
                </span>
                .
